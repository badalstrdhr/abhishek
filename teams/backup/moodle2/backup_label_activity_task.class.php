...
/**
 * Defines backup_teams_activity_task class
 *
 * @package     mod_teams
 * @category    backup
...
/**
 * Provides the steps to perform one complete backup of the teams instance
 */
class backup_teams_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the teams.xml file
     */
