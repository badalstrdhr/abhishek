...
namespace mod_teams\completion;

use core_completion\activity_custom_completion;

/**
 * Activity custom completion subclass for the teams.
 *
 * Class for defining mod_teams's custom completion rules and fetching the completion statuses
 * of the custom completion rules for a given teams instance and a user.
 *
 * @package    mod_teams
